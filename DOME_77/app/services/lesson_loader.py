...
from app.services.authored_content import load_authored_lesson
...
def load_lesson(lesson_id: str) -> dict:
    # Content Studio writes an immutable-on-save, validated ``content_v1``
    # lesson below storage_root.  It takes precedence over a bundled lesson of
    # the same id; bundled JSON remains the fallback for legacy DOME lessons.
    ...
    timeline_path = path.parent / "timeline.json" if path is not None else None
