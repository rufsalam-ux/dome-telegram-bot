...
CONFIG_DIR = ROOT / "config"  # bundled defaults
CONFIG_DIR.mkdir(parents=True, exist_ok=True)
SETTINGS_DIR = settings.storage_root / "platform-settings"
...
DEFAULT_FEATURES: dict[str, Any] = {
    ...
    "features": {
        ...
        "lesson_replays": {"mode": "enabled", "title": "До двух прохождений урока"},
        ...
        "realtime_reading": {"mode": "enabled", "title": "Адаптивное чтение и чтение по ролям"},
...
DEFAULT_PRICING: dict[str, Any] = {
    ...
    "interest_lessons": {
        ...
        "include_three_runs_cost": False,
        "include_two_runs_cost": True,
