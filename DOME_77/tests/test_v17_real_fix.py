...
def test_suitcase_action_and_followup_voice_are_mandatory_for_the_movie():
 ...
 assert by["slide_24"]["voice_after_action_optional"] is False
 assert by["slide_24"]["requiredForMovie"] is True
