...
const DEMO_001_LAYOUT:{lesson:any;slides:Record<string,AvatarSlideLayout>}={
  lesson:{
    ...
    hero_layout:{
      anchors:{
        ...
        left_of_lyosha:[0.04,0.32,0.365,0.52],
        left_of_mila:[0.12,0.40,0.44,0.55],
      },
  ...
  slides:{
    ...
    slide_19:{hero_visibility:'scene',hero_anchor:'left_of_lyosha',hero_box:[0.04,0.32,0.365,0.52],hero_fallback_anchors:[],hero_facing:'right',hero_target_visual_height_ratio:.52,hero_min_visual_height_ratio:.32,protected_character_boxes:[[0.42,0.28,0.24,0.56]]},
    slide_20:{hero_visibility:'scene',hero_anchor:'left_of_mila',hero_box:[0.12,0.40,0.44,0.55],hero_fallback_anchors:[],hero_facing:'right',hero_target_visual_height_ratio:.55,hero_min_visual_height_ratio:.40,protected_character_boxes:[[0.58,0.34,0.22,0.61]]},
