...
export interface ChildProfile{id:string;parentId:string;name:string;age?:number;learningLanguage?:string;nativeLanguage?:string;languageLevel?:string;workingDifficulty?:number;courseId?:string;activeCharacterId?:string|number|null;heroUrl?:string|null}
