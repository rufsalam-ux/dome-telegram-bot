...
def lesson_voice_keyboard(language: str = "ru", *, allow_skip: bool = False) -> InlineKeyboardMarkup:
    rows = [[InlineKeyboardButton(text=("🆘 Помощь" if language == "ru" else "🆘 Help"), callback_data="lesson:help")]]
    if allow_skip:
        rows.append([InlineKeyboardButton(text=("⏭ Пропустить задание" if language == "ru" else "⏭ Skip task"), callback_data="lesson:skip")])
    rows.append([InlineKeyboardButton(text=tr(language, "back_menu"), callback_data="menu:open")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
def payment_plans_keyboard(language: str) -> InlineKeyboardMarkup:
    ru = language == "ru"
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=("Пробный урок" if ru else "Trial lesson"), callback_data="payment:plan:trial")],
        [InlineKeyboardButton(text=("Групповой тариф" if ru else "Group plan"), callback_data="payment:plan:group")],
        [InlineKeyboardButton(text=("Индивидуальный тариф" if ru else "Individual plan"), callback_data="payment:plan:individual")],
        [InlineKeyboardButton(text=tr(language, "back_menu"), callback_data="menu:open")],
    ])
...
def child_menu_keyboard(language: str = "ru", *, show_free_topic: bool = True) -> InlineKeyboardMarkup:
    rows = [
        [InlineKeyboardButton(text=tr(language, "continue_lesson"), callback_data="lesson:continue")],
        [InlineKeyboardButton(text=tr(language, "available_lessons"), callback_data="menu:lessons_child")],
        [InlineKeyboardButton(text=tr(language, "games"), callback_data="menu:games")],
    ]
    if show_free_topic:
        rows.append([InlineKeyboardButton(text=tr(language, "free_topic"), callback_data="menu:free_topic")])
    rows.extend([
        [InlineKeyboardButton(text=tr(language, "my_character"), callback_data="menu:character")],
        [InlineKeyboardButton(text=tr(language, "profile"), callback_data="menu:profile")],
        [InlineKeyboardButton(text=tr(language, "back_menu"), callback_data="menu:open")],
...
def parent_menu_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=tr(language, "my_progress"), callback_data="menu:progress_parent")],
        [InlineKeyboardButton(text=tr(language, "set_email"), callback_data="menu:set_email")],
        [InlineKeyboardButton(text=tr(language, "change_languages"), callback_data="menu:languages")],
        [InlineKeyboardButton(text=tr(language, "birthday"), callback_data="menu:birthday")],
        [InlineKeyboardButton(text=("💳 Оплата" if language == "ru" else "💳 Billing"), callback_data="menu:payment")],
