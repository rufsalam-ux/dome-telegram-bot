...
def register_routes(app: web.Application, include_index: bool = True) -> None:
    ...
    app.router.add_get('/api/activity-types', activity_types)
    app.router.add_get('/api/courses', get_courses); app.router.add_post('/api/courses', post_course); app.router.add_put('/api/courses/{course_id}/schedule', put_course_schedule)
